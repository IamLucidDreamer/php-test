                        ...
                        <div class="card-body ">
                           ...
                           <div class="tab-content tab-space">
                              ...
                              <div class="tab-pane active" id="profile">
                                 ...
                                 <form class="form-horizontal" method="POST" action="{{route('admin-store-faq')}}">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" value="" placeholder="Please enter title" name="title" class="form-control" required>

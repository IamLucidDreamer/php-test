            ...
            <div class="card-body ">
               <div class="tab-content tab-space">
                  <div class="tab-pane active" id="profile">
                     ...
                     <form class="form-horizontal" method="POST" action="{{route('admin-update-interest',$interest->id)}}">
                        @csrf
                        <div class="row">
                           <label class="col-md-3 col-form-label">Interest Name</label>
                           <div class="col-md-9">
                              <div class="form-group">
                                 <input type="text" value="{{$interest->name}}" name="name" class="form-control" required="">
                              </div>
                              @if ($errors->has('name'))

                        ...
                        <div class="card-body ">
                           ...
                           <div class="tab-content tab-space">
                              ...
                              <div class="tab-pane active" id="profile">
                                 ...
                                 <h4 class="card-title">Manage Challnege  {{config('app.name')}} </h4>

                                 <form class="form-horizontal" method="POST" action="{{route('admin-store-challenge')}}">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" value="" placeholder="Please enter name" name="challenge_name" class="form-control">
                                      ...
                                      <div class="row">
                                       ...
                                       <div class="col-md-9">
                                          ...
                                          <div class="form-group">
                                             ...
                                             <input type="text" value="" placeholder="Please enter name" name="expiry_date" class="form-control">
